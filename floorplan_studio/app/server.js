...
const server = http.createServer(async (req, res) => {
  ...
  try {
    ...
    const SHARED = ['annotations.js', 'room-identity.js', 'ui-navigation.js', 'input-actions.js', 'plan-scene.js', 'flooring.js', 'shapes.js', 'sun.js', 'controls.js', 'entity-bindings.js', 'lighting.js'];

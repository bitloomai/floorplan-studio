...
window.API = (function () {
  ...
  return {
    ...
    clientId: () => CLIENT_ID,
    /* `base` is the `savedAt` of the copy this document was built on. A server
     * that has been written since answers 409 with its project, and the caller
     * merges (main.js `save`). */
    saveProject: (project, base) => req('api/project', {
      method: 'PUT',
      headers: Object.assign({ 'X-FPS-Client': CLIENT_ID }, base ? { 'X-FPS-Base': base } : {}),

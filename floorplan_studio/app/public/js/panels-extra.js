...
window.PanelsExtra = (function () {
  ...
  function flooringField(box, room) {
    ...
    box.appendChild(field('Flooring', h('select', {
    ...
    if (def.generator === 'script') {
      box.appendChild(h('p', { class: 'hint' }, 'This flooring is generated by a script in flooring.json. Edit it there to change the pattern.'));
    }
  ...
  return { flooringField, roomExtras, renderOpeningPanel, sunDialog, wallLabel, entityRow, editRoomButtons, editFilter, aimFields, lampFields, shortcutsEditor, logicDialog };
}());

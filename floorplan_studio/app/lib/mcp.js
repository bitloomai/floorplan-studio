...
A light BUILT INTO a device — a ceiling fan's light kit — is bound on the fan as props.light, never as a separate fan_light marker on top of it: the plan draws its light from the fan and counts it as one of the room's lights.
...
sensor, a fan with a built-in light kit opens that light, and failing that hold opens the marker's own entity), and 'hitRect'

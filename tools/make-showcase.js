...
/* -------------------------------------------------------------- dashboard --
 *
 * What the generated dashboard shows around the plan. The README's hero
 * animation (`make-hero.js`) and the live demo on the help site both run the
 * real cards against this house, so the house card needs a household and some
 * readings of its own. Invented like everything else in this file: every id
 * begins `demo_`, and the three people are a first name and nothing more.
 *
 * None of it draws on the plan, so `docs/showcase-plan.svg` does not move. */
const DASHBOARD = {
  house: {
    title: 'Aria House',
    weather: 'weather.demo_home',
    people: ['person.demo_maya', 'person.demo_leo', 'person.demo_nora'],
    counts: [
      { icon: 'bulb', label: 'lights', domain: 'light' },
      { icon: 'fanBlades', label: 'fans', types: ['fan', 'fan_exhaust'] },
      { icon: 'snowflake', label: 'AC', types: ['ac'] },
      { icon: 'screen', label: 'media', types: ['tv', 'speaker'] },
    ],
    stats: [
      { icon: 'energy', label: 'now', entity: 'sensor.demo_power', format: 'power', signed: true, name: 'Home power' },
      { icon: 'solar', label: 'solar', entity: 'sensor.demo_solar', format: 'power', name: 'Solar now' },
      { icon: 'power', label: 'battery', entity: 'sensor.demo_battery', format: 'percent', name: 'Battery' },
      { icon: 'droplet', label: 'tank', entity: 'sensor.demo_tank', format: 'percent', name: 'Water tank' },
      /* The chip that only exists while something is happening. */
      { icon: 'timer', entity: 'sensor.demo_washer', valueEntity: 'sensor.demo_washer_remaining', format: 'duration',
        prefix: 'Washing ·', suffix: 'left', tone: 'warm', name: 'Washer',
        showWhen: { entity: 'sensor.demo_washer', is: ['running'] } },
    ],
  },
};

/* The house's own buttons. A shortcut only ever names something that already
 * exists; these are a scene and a script the demo's stand-in Home Assistant
 * (`demo-hass.js`) knows how to run. `section: 'house'` keeps them on the house
 * card rather than repeated in every room's popup. */
const HOUSE_SHORTCUTS = [
  { id: 'goodnight', label: 'Goodnight', entity: 'scene.demo_goodnight', section: 'house' },
  { id: 'away', label: 'Away', entity: 'script.demo_away', section: 'house' },
];

/* ------------------------------------------------------------ a day here --
 *
 * What the house does all day, for the stand-in Home Assistant that drives the
 * live demo and the hero animation (`tools/demo-hass.js` reads it). Spans are
 * UTC on the equinox the still is drawn on — the same clock the sun uses — and
 * wrap past midnight when the end is earlier than the start. Nothing here draws
 * on the plan, and nothing here is anybody's routine but these three invented
 * people's. */
const DEMO_LIFE = {
  date: '2026-09-21',
  people: {
    'person.demo_maya': { away: [['10:30', '12:15', 'Market']] },
    'person.demo_leo': { away: [['08:40', '17:45', 'Work']] },
    'person.demo_nora': { away: [['08:10', '15:30', 'School']] },
  },
  on: {
    'light.demo_kitchen_under': [['06:30', '08:15'], ['18:45', '21:00']],
    'light.demo_kitchen': [['06:30', '07:30'], ['18:45', '20:30']],
    'light.demo_bath': [['06:40', '07:05'], ['21:40', '21:55']],
    'light.demo_ens': [['06:15', '06:45'], ['22:30', '22:50']],
    'light.demo_ens_mirror': [['06:15', '06:45'], ['22:30', '22:50']],
    'light.demo_wardrobe': [['06:45', '07:00']],
    'light.demo_foyer': [['17:40', '23:00']],
    'light.demo_hall': [['06:10', '06:40'], ['17:50', '23:10']],
    'light.demo_living': [['17:50', '21:30']],
    'light.demo_living_cove': [['17:50', '23:00']],
    'light.demo_dining': [['18:30', '20:15']],
    'light.demo_dining_pendant': [['18:30', '20:45']],
    'light.demo_terrace': [['18:10', '22:00']],
    'light.demo_path': [['18:00', '06:10']],
    'light.demo_porch': [['18:00', '06:10']],
    'light.demo_yard': [['19:00', '19:20']],
    'light.demo_utility': [['18:30', '18:45']],
    'light.demo_study': [['19:30', '21:15']],
    'light.demo_bed2': [['20:30', '22:15']],
    'light.demo_bed_main': [['21:45', '22:40']],
    'fan.demo_living': [['11:30', '22:00']],
    'fan.demo_bed_main': [['13:30', '16:00'], ['21:50', '06:00']],
    'fan.demo_bed2': [['21:00', '06:00']],
    'fan.demo_utility_exhaust': [['18:30', '19:40']],
    'fan.demo_hood': [['07:20', '07:40'], ['19:00', '19:40']],
    'climate.demo_living': [['13:00', '17:00']],
    'climate.demo_bed_main': [['22:00', '02:00']],
    'climate.demo_house': [['12:00', '18:00']],
    'sensor.demo_ac_outdoor_1': [['13:00', '17:00']],
    'sensor.demo_ac_outdoor_2': [['22:00', '02:00']],
    'media_player.demo_tv': [['20:00', '22:00']],
    'media_player.demo_speaker': [['07:00', '08:00'], ['18:00', '19:30']],
    'switch.demo_hob': [['07:20', '07:35'], ['19:05', '19:40']],
    'switch.demo_bath_geyser': [['06:00', '06:45']],
    'switch.demo_board_1': [['09:00', '17:30'], ['19:30', '21:15']],
    'switch.demo_board_2': [['09:00', '17:30'], ['19:30', '21:15']],
    'switch.demo_board_3': [['22:30', '06:30']],
    'switch.demo_living_plug': [['20:00', '22:00']],
    'switch.demo_irrigation': [['06:30', '06:50']],
    'binary_sensor.demo_front_door': [['08:08', '08:11'], ['08:38', '08:41'], ['10:28', '10:31'], ['12:14', '12:17'], ['15:29', '15:33'], ['17:44', '17:48']],
    'binary_sensor.demo_gate': [['08:37', '08:42'], ['17:42', '17:47']],
    'binary_sensor.demo_hall_motion': [['06:10', '06:50'], ['08:05', '08:45'], ['15:28', '15:40'], ['17:43', '18:00'], ['18:30', '22:30']],
    'binary_sensor.demo_living_slider': [['10:00', '18:30']],
    'binary_sensor.demo_bed_main_window': [['06:30', '09:30']],
  },
  attributes: {
    'light.demo_bed_main': { brightness: 150 }, 'light.demo_bed2': { brightness: 180 },
    'light.demo_living_cove': { brightness: 170 }, 'light.demo_dining_pendant': { brightness: 205 },
    'fan.demo_living': { percentage: 60 }, 'fan.demo_bed_main': { percentage: 40 }, 'fan.demo_bed2': { percentage: 35 },
    'sensor.demo_weather': { unit_of_measurement: '°C' },
  },
  cover: { 'cover.demo_living_drape': [['06:30', '13:00', 100], ['13:00', '16:15', 45], ['16:15', '20:30', 100], ['20:30', '06:30', 0]] },
  fixed: { 'camera.demo_porch': 'streaming', 'sensor.demo_router': 'on', 'sensor.demo_db': 'on', 'sensor.demo_ev': 'off', 'sensor.demo_study_board': 'on', 'sensor.demo_weather': '29' },
  weather: { entity: 'weather.demo_home', sunrise: '06:10', sunset: '18:05', cloudy: [['14:00', '15:10']], min: 24, max: 33, peak: '15:00' },
  solar: { entity: 'sensor.demo_solar', also: ['sensor.demo_inverter'], peak: 3400, from: '06:15', to: '17:55' },
  power: { entity: 'sensor.demo_power', base: 380, domains: { fan: 45, climate: 1150, media_player: 110, switch: 60 },
    entities: { 'switch.demo_hob': 1700, 'switch.demo_bath_geyser': 1900, 'sensor.demo_washer': 480 } },
  battery: { entity: 'sensor.demo_battery', points: [['00:00', 58], ['06:15', 41], ['14:30', 97], ['24:00', 58]] },
  tank: { entity: 'sensor.demo_tank', from: 76, to: 62 },
  washer: { entity: 'sensor.demo_washer', remaining: 'sensor.demo_washer_remaining', runs: [['09:10', '10:25'], ['18:30', '19:40']] },
  /* A scene or script is what it sets; `light.*` is every light, and a later
   * line beats an earlier one. The room ones are found by the stock Scenes
   * row because their ids carry the room's id — no configuration. */
  scenes: {
    'scene.demo_goodnight': { name: 'Goodnight', set: [['light.*', 'off'], ['light.demo_path', 'on'], ['light.demo_porch', 'on'],
      ['media_player.demo_tv', 'off'], ['fan.demo_living', 'off'], ['fan.demo_bed_main', { state: 'on', percentage: 40 }],
      ['cover.demo_living_drape', { position: 0 }]] },
    'script.demo_away': { name: 'Away', set: [['light.*', 'off'], ['fan.*', 'off'], ['media_player.*', 'off'], ['climate.*', 'off']] },
    'scene.demo_living_movie_night': { name: 'Movie night', set: [['light.demo_living', 'off'],
      ['light.demo_living_cove', { state: 'on', brightness: 70 }], ['media_player.demo_tv', 'on'], ['cover.demo_living_drape', { position: 0 }]] },
    'script.demo_living_bright': { name: 'Everything bright', set: [['light.demo_living', { state: 'on', brightness: 255 }],
      ['light.demo_living_cove', { state: 'on', brightness: 255 }]] },
    'scene.demo_dining_dinner': { name: 'Dinner', set: [['light.demo_dining', { state: 'on', brightness: 110 }],
      ['light.demo_dining_pendant', { state: 'on', brightness: 230 }]] },
    'script.demo_bed_main_wind_down': { name: 'Wind down', set: [['light.demo_bed_main', { state: 'on', brightness: 60 }],
      ['fan.demo_bed_main', { state: 'on', percentage: 30 }], ['light.demo_ens_mirror', 'off']] },
  },
};
...
module.exports = { project, floor, items, ROOMS, INDOOR, OUTDOOR, OPENINGS, B, PLOT, build, statesFor, STILL, LAMPS_ON, DASHBOARD, DEMO_LIFE };

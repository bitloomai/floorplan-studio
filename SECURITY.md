...
Floorplan Studio is an alpha. It has been tested on a real Home Assistant
installation, but no version is yet supported for production use, and the
`experimental` Home Assistant stage is intentional.
